        ...
        <>
            <div class="About"  >
                ...
                <div class="about2">
                    ...
                    <h5 class="w3-center" id="ht1" style={{ fontSize: "26px", fontFamily: "serif", marginTop: "5px" }}>Tradition since 1889</h5>
                    ...
                    <div id="ht13"> Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute iruredolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.We only use</div>
